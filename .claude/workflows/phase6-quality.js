...
for (let round = 1; round <= 3; round++) {
  ...
  gate4Report = await agent(
    ...
    + '3. G4b: Evaluate all 15 dims inline per ' + REPO + '/harness/ssi/prompts/evaluate_dimension.md → .sessi-work/gate4_result.json.\n'
    + '   Dims: linting(90) type_safety(85) test_coverage(80) security(80) secrets_scanning(100) license_compliance(100) mutation_testing(70) architecture(80) readability(80) error_handling(80) documentation(75) performance(75) integration_coverage(75) test_assertion_quality(70).\n'
...
const advanceReport = await agent(
  ...
  + '   TDD-PRECHECK enforced: gitleaks + ruff + mypy + pytest --cov-fail-under=100 + spec-coverage 90% + mutmut. Fix blockers, re-run.\n'
