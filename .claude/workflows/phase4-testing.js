...
for (let round = 1; round <= 3; round++) {
  ...
  gate3Report = await agent(
    ...
    + '   16 dims: linting(90) type_safety(85) test_coverage(80) security(80) secrets_scanning(100) license_compliance(100) mutation_testing(70) integration_coverage(60) architecture(80) readability(80) error_handling(80) documentation(75) test_assertion_quality(60) performance(75).\n'
...
const advanceReport = await agent(
  ...
  + '   TDD-PRECHECK enforced: gitleaks + ruff + mypy + pytest --cov-fail-under=100 + spec-coverage 80% + mutmut. Fix any blocker, re-run.\n'
