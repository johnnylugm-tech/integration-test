...
for (let round = 1; round <= 3; round++) {
  ...
  gate2Report = await agent(
    ...
    + '   Dims: linting(90) type_safety(85) test_coverage(80) security(80) secrets_scanning(100) license_compliance(100) mutation_testing(70) integration_coverage(60) test_assertion_quality(60).\n'
...
const advanceReport = await agent(
  ...
  + '   TDD-PRECHECK enforced: gitleaks + ruff + mypy + pytest --cov-fail-under=100 + spec-coverage 60% + mutmut. Fix any blocker, re-run.\n'
